...
class _MealPlanPageState extends State<MealPlanPage> {
  ...
  final Map<String, List<Map<String, dynamic>>> mealPlans = {
    'Balanced': [
      ...
      {
        'meal': 'Lunch',
        'item': 'Grilled Chicken + Rice + Veggies',
        'calories': 600,
        'protein': 35,
        'fat': 10,
        'carbs': 60
      ...
      {
        'meal': 'Dinner',
        'item': 'Fish + Sweet Potato + Broccoli',
        'calories': 500,
        'protein': 30,
        'fat': 12,
        'carbs': 45
    ...
    'Greek': [
      {
        'meal': 'Breakfast',
        'item': 'Greek Yogurt + Honey + Berries',
        'calories': 320,
        'protein': 15,
        'fat': 8,
        'carbs': 35
      ...
      {
        'meal': 'Dinner',
        'item': 'Stuffed Peppers + Feta Cheese',
        'calories': 500,
        'protein': 20,
        'fat': 18,
        'carbs': 45
      ...
      body: Column(
        ...
        children: [
          const Padding(
            ...
            child: Text('Select your diet type:', style: TextStyle(fontSize: 16)),
          ),
          Padding(
